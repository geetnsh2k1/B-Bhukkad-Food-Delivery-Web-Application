...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('food_items', '0052_auto_20201128_2152'),
    ]

    operations = [
        migrations.RenameModel(
            old_name='OrdersHistory',
            new_name='History',
        ),
        ...
        migrations.AlterField(
            model_name='order',
            name='customer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cust', to='home.customer'),
        ),
        migrations.AlterField(
            model_name='order',
            name='status',
